...
export default function ColorDropdown({ editor }: { editor: Editor }) {
  ...
  return (
    ...
    <Root>
      <Trigger
        // className="flex items-center gap-1 justify-center hover:text-neutral-500 hover:bg-neutral-100 rounded-lg dark:hover:bg-neutral-800 text-neutral-600 dark:text-neutral-200 dark:border-neutral-600"
        className="trigger"
      >
      ...
      >
        <div
          // className="flex flex-col gap-4 z-50 py-4 px-4 min-w-45 rounded-2xl bg-white shadow-md shadow-neutral-100 text-neutral-600 dark:bg-neutral-800/60 ring-1 dark:ring-neutral-800 dark:text-neutral-200 dark:shadow-neutral-950 ring-neutral-200"
        ...
        >
          ...
          {recentColors.length > 0 && (
            <div className="flex flex-col gap-2">
              <span className="dropdown-subtitle">Recent</span>
          ...
          {/* --- Main Text Colors --- */}
          <div className="flex flex-col gap-2">
            <span className="dropdown-subtitle">Color</span>
          ...
          <div className="flex flex-col gap-1.5">
            <span className="dropdown-subtitle">Background</span>
            <div className="grid grid-cols-4 gap-2">
              {COLORS.map(c => (
                <span
                  key={c.hex + '-bg'}
