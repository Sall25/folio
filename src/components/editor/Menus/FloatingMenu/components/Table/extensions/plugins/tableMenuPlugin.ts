...
import { getCellIndices, getEdgeFlags, getHeaderCellRect, getRowRange, getRowRect, getRowStart, getTableContext } from "../utils";
...
export const tableMenuPlugin = new Plugin({
