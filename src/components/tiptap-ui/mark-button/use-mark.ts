...
// --- Icons ---
import { BoldIcon } from "src/components/tiptap-icons/bold-icon";
import { Code2Icon } from "src/components/tiptap-icons/code2-icon";
import { ItalicIcon } from "src/components/tiptap-icons/italic-icon";
import { StrikeIcon } from "src/components/tiptap-icons/strike-icon";
import { SubscriptIcon } from "src/components/tiptap-icons/subscript-icon";
import { SuperscriptIcon } from "src/components/tiptap-icons/superscript-icon";
import { UnderlineIcon } from "src/components/tiptap-icons/underline-icon";
