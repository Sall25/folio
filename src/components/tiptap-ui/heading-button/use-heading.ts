...
// --- Icons ---
import { HeadingOneIcon } from "src/components/tiptap-icons/heading-one-icon";
import { HeadingTwoIcon } from "src/components/tiptap-icons/heading-two-icon";
import { HeadingThreeIcon } from "src/components/tiptap-icons/heading-three-icon";
import { HeadingFourIcon } from "src/components/tiptap-icons/heading-four-icon";
import { HeadingFiveIcon } from "src/components/tiptap-icons/heading-five-icon";
import { HeadingSixIcon } from "src/components/tiptap-icons/heading-six-icon";
