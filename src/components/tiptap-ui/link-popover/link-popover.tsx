...
import { ExternalLinkIcon } from "src/components/tiptap-icons/external-link-icon";
import { LinkIcon } from "src/components/tiptap-icons/link-icon";
import { TrashIcon } from "src/components/tiptap-icons/trash-icon";

// --- Tiptap UI ---
import type { UseLinkPopoverConfig } from "src/components/tiptap-ui/link-popover";
import { useLinkPopover } from "src/components/tiptap-ui/link-popover";
