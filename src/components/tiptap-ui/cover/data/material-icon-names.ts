// Auto-generated from the material-symbols package (index.d.ts).
// 3894 verified Material Symbols names — every one renders in the
// Material Symbols Rounded font loaded in index.html.
// Regenerate: npm i -D material-symbols, then re-run the extraction script.

export const MATERIAL_ICON_NAMES: string[] = [
  "10k",
  "10mp",
  "11mp",
  "123",
