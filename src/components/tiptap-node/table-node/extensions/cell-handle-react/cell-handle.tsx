...
import {
  CellHandlePlugin,
  cellHandlePluginDefaultKey,
  type CellHandlePluginProps,
} from "../cell-handle/cell-handle-plugin";
...
export type CellHandleProps = Omit<
  Optional<CellHandlePluginProps, "pluginKey">,
  "element"
> & {
  className?: string;
  onNodeChange?: (data: {
