...
function evaluateRule(rule: FilterRule, record: Page): boolean {
  const value = record ? record.values?.[rule.propertyId] : null;
...
function evaluateGroup(group: FilterGroup, record: Page): boolean {
