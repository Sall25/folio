  ...
  const handleUpload = async (files: File[]) => {
    ...
    if (urls.length > 0) {
      ...
      if (isValidPosition(pos)) {
        const figureNodes = urls.map((url, index) => {
          const filename =
          ...
          return {
            ...
            attrs: {
              width: 300,
              showCaption: false,
              ...replaceAttrs, // ← inherit old width, alt, etc.
              src: url, // ← always override src with new upload
              alt: replaceAttrs.alt ?? filename,
            },
        ...
        props.editor
          ...
          .insertContentAt(pos, figureNodes)
          .run();
